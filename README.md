<h1 align="center">Vrushali Parmar</h1>

<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&pause=1000&color=F7C300&width=435&lines=Welcome+to+my+GitHub+Profile!;I'm+an+Electronics+%26+Telecom+Engineer;Always+learning+%7C+Always+building" alt="Typing SVG" />
  </a>
</p>
...
🎓 B.Tech E&TC student at Cummins College of Engineering, Pune  
🔬 Researcher | Developer | Content Creator  
💡 Passionate about low-power VLSI design, software development, and mental well-being initiatives.
...
<img src="https://img.shields.io/badge/Data%20Visualization-F7931E?style=for-the-badge&logo=plotly&logoColor=white"/>
...
- **Research on Low Power Flip-Flops** *(Ongoing)*  
  - Focused on designing and simulating energy-efficient flip-flops using various CMOS logic families.  
  - Tools: Cadence Virtuoso  
  - Goal: To reduce dynamic and static power consumption in VLSI circuits.
...
- **ACM Student Chapter** – *Content Team Member*  
  - Created and managed technical content for club initiatives and events.

- **Happy Hours Club (Mental Health Club)** – *Happiness Team*  
  - Organized events and created content to promote mental wellness and positivity on campus.
...
- **Data Analysis Job Simulation** – *by Accenture (North America) on Forage*
...
- 🔗 [LinkedIn – Vrushali Parmar](https://www.linkedin.com/in/vrushali-parmar-259669397/)
